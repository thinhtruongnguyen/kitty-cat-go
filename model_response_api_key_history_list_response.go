...
// checks if the ResponseApiKeyHistoryListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseApiKeyHistoryListResponse{}

// ResponseApiKeyHistoryListResponse struct for ResponseApiKeyHistoryListResponse
...
func NewResponseApiKeyHistoryListResponse() *ResponseApiKeyHistoryListResponse {
	this := ResponseApiKeyHistoryListResponse{}
...
func (o *ResponseApiKeyHistoryListResponse) GetData() ResponseApiKeyHistoryListData {
	if o == nil || IsNil(o.Data) {
		var ret ResponseApiKeyHistoryListData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ResponseApiKeyHistoryListData and assigns it to the Data field.
...
func (o ResponseApiKeyHistoryListResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseApiKeyHistoryListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseApiKeyHistoryListResponse struct {
	value *ResponseApiKeyHistoryListResponse
	isSet bool
}

func (v NullableResponseApiKeyHistoryListResponse) Get() *ResponseApiKeyHistoryListResponse {
	return v.value
}

func (v *NullableResponseApiKeyHistoryListResponse) Set(val *ResponseApiKeyHistoryListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseApiKeyHistoryListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseApiKeyHistoryListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseApiKeyHistoryListResponse(val *ResponseApiKeyHistoryListResponse) *NullableResponseApiKeyHistoryListResponse {
	return &NullableResponseApiKeyHistoryListResponse{value: val, isSet: true}
}

func (v NullableResponseApiKeyHistoryListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseApiKeyHistoryListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
