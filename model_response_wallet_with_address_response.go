...
// checks if the ResponseWalletWithAddressResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseWalletWithAddressResponse{}

// ResponseWalletWithAddressResponse struct for ResponseWalletWithAddressResponse
...
func NewResponseWalletWithAddressResponse() *ResponseWalletWithAddressResponse {
	this := ResponseWalletWithAddressResponse{}
...
func (o *ResponseWalletWithAddressResponse) GetData() ModelsWalletWithAddress {
	if o == nil || IsNil(o.Data) {
		var ret ModelsWalletWithAddress
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ModelsWalletWithAddress and assigns it to the Data field.
...
func (o ResponseWalletWithAddressResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseWalletWithAddressResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseWalletWithAddressResponse struct {
	value *ResponseWalletWithAddressResponse
	isSet bool
}

func (v NullableResponseWalletWithAddressResponse) Get() *ResponseWalletWithAddressResponse {
	return v.value
}

func (v *NullableResponseWalletWithAddressResponse) Set(val *ResponseWalletWithAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseWalletWithAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseWalletWithAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseWalletWithAddressResponse(val *ResponseWalletWithAddressResponse) *NullableResponseWalletWithAddressResponse {
	return &NullableResponseWalletWithAddressResponse{value: val, isSet: true}
}

func (v NullableResponseWalletWithAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseWalletWithAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
