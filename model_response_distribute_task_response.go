...
// checks if the ResponseDistributeTaskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseDistributeTaskResponse{}

// ResponseDistributeTaskResponse struct for ResponseDistributeTaskResponse
...
func NewResponseDistributeTaskResponse() *ResponseDistributeTaskResponse {
	this := ResponseDistributeTaskResponse{}
...
func (o ResponseDistributeTaskResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseDistributeTaskResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseDistributeTaskResponse struct {
	value *ResponseDistributeTaskResponse
	isSet bool
}

func (v NullableResponseDistributeTaskResponse) Get() *ResponseDistributeTaskResponse {
	return v.value
}

func (v *NullableResponseDistributeTaskResponse) Set(val *ResponseDistributeTaskResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseDistributeTaskResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseDistributeTaskResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseDistributeTaskResponse(val *ResponseDistributeTaskResponse) *NullableResponseDistributeTaskResponse {
	return &NullableResponseDistributeTaskResponse{value: val, isSet: true}
}

func (v NullableResponseDistributeTaskResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseDistributeTaskResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
